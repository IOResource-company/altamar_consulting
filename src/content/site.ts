...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    role: "Associate",
    kind: "associate",
    focus: "AI & supply chain operations",
    bio: "Co-founder of ShipItDone and NYNJA, with 20+ years in supply chain, logistics and technology across the US and Asia. Marshall puts AI to work in real operations — from process documentation to software builds — and brings a hands-on operator's view of where it pays off.",
    linkedin: "https://www.linkedin.com/in/marshalltaplits",
    affiliation: "ShipItDone · NYNJA",
    order: 3,
    published: true,
  },
  {
    ...
    role: "Associate",
    kind: "associate",
    focus: "MCP & AI integration",
    bio: "A product and engineering builder with 25 years across HSBC, CNN, AIA and LVMH-DFS, now based in Singapore. Brent builds Model Context Protocol (MCP) servers and Swift tooling that connect AI assistants to real systems, and teaches at the Apple Developer Academy Bali.",
    linkedin: "https://www.linkedin.com/in/deverman",
    affiliation: "Apple Developer Academy Bali",
    order: 4,
    published: true,
  },
  {
    name: "Douglas Menelly",
    role: "Associate",
    kind: "associate",
    focus: "AI education & enablement",
    bio: "Founder of the Long Island AI Academy, where he teaches a structured, ethical grounding in AI. Douglas pairs heavy technical training — engineering degrees, an NYU operations masters and a Columbia Executive MBA — with hands-on command of 24+ AI tools, and teaches AI as frameworks for real problem-solving, not shortcuts.",
